...
class Game(tk.Tk):
    ...
    def create_common_menu(self) -> None:
        ...
        self.submenu.add_command(label="Правила", command=self.rules)
    ...
    def rules(self):
        """
        Метод для вывода окна "Правила"

        :return: None
        """

        if Config.DEBUG: print('Game rules')
        ...
        messagebox.showinfo("Правила игры",
                            ...
                            "Регистрозависимый ввод - фиолетовый фон поля.\n"
                            "Игнорирование регистра при вводе - зеленый фон поля.\n\n"
                            "Время в секундах на уровнях:\n"
                            "1, 2 = длина текста + 1.\n"
                            "3, 4, 5 = длина текста + 2.\n"
                            "6, 7 = длина текста + 1, если регистрозависимый ввод.\n"
                            "8 = 70% от длины предложения\n\n"
                            "Успей набрать символы!")
